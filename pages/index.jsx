...
<center>
         <Typography variant="h3" component="h3" color="textSecondary" gutterBottom>
                  You can light your path through MIT with other course scheduling services. But only FireRoad053 can reasonably <div style={{color:"blue"}}><i><strong>OPTIMIZE</strong></i></div> your journey through this mystical land.
              </Typography>
              <br></br>
